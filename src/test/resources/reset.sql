...
delete from pattern;
INSERT INTO user VALUES (1,'kracchini@madisoncollege.edu','kmracchini','Kristin Racchini'),(2,'rey@macarthurpark.com','ReyTheCat','Rey Hinnendael'), (3,'maleficent@macarthurpark.com','QueenOfMean','Maleficent Racchini');
